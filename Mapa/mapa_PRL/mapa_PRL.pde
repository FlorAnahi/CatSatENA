...
// Mapa
float mapCenterLat = 21.855476;
float mapCenterLon = -102.290752;
int zoomLevel = 15;
...
void setup(){
  ...
  mapa = gMapper.getMap();
  minLatCatSatY = 22.864707;
  maxLatCatSatY = 21.838856;
  minLonCatSatX = -102.265379;
  maxLonCatSatX = -102.321769;
  ...
  printArray(Serial. list());
   ENASerial= new Serial (this, Serial.list()[0], 115200);//[numero serial] detectar automatico el puerto del arduino A
   background (200);
   noFill();
   stroke(#663399,25);
   smooth ();
...
stroke(44,56,78);
fill(255);
ellipse(Latitud,Longitud, 30, 30);
